...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    Company: ['About Us', 'How We Deliver', 'Ways to Work', 'Tech & Tools', 'Careers', 'Contact'],
    Resources: ['Case Studies', 'Blog', 'Documentation', 'Support', 'Privacy Policy', 'Terms of Service'],
  };
